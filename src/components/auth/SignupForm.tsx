...
import { createUserAccount, type SignupState } from "@/app/signup/actions";
  ...
  return (
    <form action={formAction} noValidate className="space-y-5">
      ...
      <div className="space-y-2">
        <label htmlFor="su-name" className="block text-sm font-semibold text-[#202124]">
          Name
        </label>
      ...
      <div className="space-y-2">
        <label htmlFor="su-email" className="block text-sm font-semibold text-[#202124]">
          Email address
        </label>
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-[#5F6368] group-focus-within:text-[#1A73E8] transition-colors">
      ...
      <div className="space-y-2">
        <label htmlFor="su-password" className="block text-sm font-semibold text-[#202124]">
          Password
        </label>
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-[#5F6368] group-focus-within:text-[#1A73E8] transition-colors">
